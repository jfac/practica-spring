package com.spring.mvc.service.test;
...
public class SimpleProductoManagerTests {
    ...
    public void setUp() throws Exception {
        ...
        product.setDescrption("Chair");
        product.setPrice(CHAIR_PRICE);
        products.add(product);
        
        product = new Producto();
        product.setDescrption("Table");
    ...
    public void testGetProducts() {
        ...
        assertEquals(CHAIR_DESCRIPTION, product.getDescrption());
        assertEquals(CHAIR_PRICE, product.getPrice());
        
        product = products.get(1);
        assertEquals(TABLE_DESCRIPTION, product.getDescrption());
    ...
    public void testIncreasePriceWithEmptyListOfProducts() {
        try {
            productManager = new SimpleProductManager();
            productManager.setProductDao(new InMemoryProductDao(new ArrayList<Producto>()));
